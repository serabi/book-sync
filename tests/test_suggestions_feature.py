...
class TestSuggestionsFeature(unittest.TestCase):
    ...
    def test_settings_save_toggle(self, mock_restart):
        ...
        # 2. Turn ON
        response = self.client.post("/settings", data={"SUGGESTIONS_ENABLED": "on", "SYNC_PERIOD_MINS": "5"})
    ...
    def test_match_resolves_suggestions(self):
        ...
        try:
            ...
            self.client.post("/match", data={"audiobook_id": "abc-123", "ebook_filename": "test.epub"})
