...
class TestHardcoverResolveEndpoint(unittest.TestCase):
    ...
    def test_resolve_auto_match_by_isbn_success(self):
        ...
        self.mock_container.mock_abs_client.get_item_details.return_value = {
            "media": {"metadata": {"title": "Test Book", "authorName": "ABS Author", "isbn": "9781234567890"}}
        }
    ...
    def test_resolve_manual_input_success(self):
        ...
        response = self.client.get(
            "/api/hardcover/resolve?abs_id=any-book&input=https://hardcover.app/books/manual-book"
        )
...
class TestLinkHardcoverEndpoint(unittest.TestCase):
    ...
    def test_link_json_success(self):
        ...
        response = self.client.post(
            ...
            json={"book_id": 12345, "edition_id": 67890, "pages": 300, "title": "Test Book", "slug": "test-book"},
    ...
    def test_link_json_missing_book_id_returns_400(self):
        ...
        response = self.client.post(
            "/link-hardcover/test-abs-id", json={"edition_id": 67890, "title": "Test"}, content_type="application/json"
        )
...
class TestGetBookAuthor(unittest.TestCase):
    ...
    def test_get_book_author_success(self):
        ...
        client = HardcoverClient()
        client.query = Mock(
            return_value={"books_by_pk": {"cached_contributors": [{"author": {"name": "J.K. Rowling"}}]}}
        )
    ...
    def test_get_book_author_no_contributions(self):
        ...
        client = HardcoverClient()
        client.query = Mock(return_value={"books_by_pk": {"cached_contributors": []}})
