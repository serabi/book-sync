...
class TestClientRaisesDoesNotBlockOthers:
    ...
    @patch.dict(
        os.environ,
        {
            ...
            "GRIMMORY_POLL_MODE": "custom",
            "GRIMMORY_POLL_SECONDS": "10",
            "GRIMMORY_2_POLL_MODE": "global",
    ...
    def test_failing_client_does_not_block_next_client(self):
        ...
        grimmory_state = _make_state_result(0.5)
        grimmory = _make_sync_client(configured=True, states={1: grimmory_state})
        ...
        # Storyteller failed, but Grimmory should still have been polled
        grimmory.get_service_state.assert_called_once()
