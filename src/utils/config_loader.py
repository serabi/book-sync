...
ALL_SETTINGS = [
    ...
    # Booklore 2
    'BOOKLORE_2_ENABLED', 'BOOKLORE_2_LABEL', 'BOOKLORE_2_SERVER', 'BOOKLORE_2_WEB_URL', 'BOOKLORE_2_USER', 'BOOKLORE_2_PASSWORD', 'BOOKLORE_2_SHELF_NAME', 'BOOKLORE_2_LIBRARY_ID',
